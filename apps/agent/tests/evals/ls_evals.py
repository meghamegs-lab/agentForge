#!/usr/bin/env python3
"""
LangSmith Evaluation Suite — tests/evalsNew/ls_evals.py
====================================================
...
---
    ...
    python tests/evalsNew/ls_evals.py

    # Single eval type:
    python tests/evalsNew/ls_evals.py --only correctness
    python tests/evalsNew/ls_evals.py --only safety
    python tests/evalsNew/ls_evals.py --only latency
    python tests/evalsNew/ls_evals.py --only consistency
    python tests/evalsNew/ls_evals.py --only tool-keywords

    # Custom LangSmith experiment prefix (e.g. for a branch):
    python tests/evalsNew/ls_evals.py --prefix feat/my-branch
